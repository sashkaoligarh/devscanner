// Safe electron API wrapper — prevents crashes when window.electron is unavailable
const electron = {
  ...
  getDiagnostics: () => window.electron?.getDiagnostics?.() ?? Promise.resolve({ logPath: null }),
  logDiagnostic: (message, data) => window.electron?.logDiagnostic?.(message, data) ?? Promise.resolve({ success: true }),
  ...
  listWslDirectories: (o) => window.electron?.listWslDirectories?.(o) ?? Promise.resolve({ success: false, error: 'Not available' }),
  resolveWslFolder: (o) => window.electron?.resolveWslFolder?.(o) ?? Promise.resolve({ success: false, error: 'Not available' }),
  ...
  deploySetupState: (o) => window.electron?.deploySetupState?.(o) ?? Promise.resolve({ success: false, error: 'Restart DevScanner to load saved deployments' }),
  deploySetupSaveDraft: (o) => window.electron?.deploySetupSaveDraft?.(o) ?? Promise.resolve({ success: false, error: 'Restart DevScanner to save deployment drafts' }),
  ...
  deploySetupCheck: (o) => window.electron?.deploySetupCheck?.(o) ?? Promise.resolve({ success: false, error: 'Not available' }),
  deployAssistantSettings: (o) => window.electron?.deployAssistantSettings?.(o) ?? Promise.resolve({ success: false, error: 'Restart DevScanner to enable Codex' }),
  deployAssistantHistory: (o) => window.electron?.deployAssistantHistory?.(o) ?? Promise.resolve({ success: false, error: 'Not available' }),
  deployAssistantRun: (o) => window.electron?.deployAssistantRun?.(o) ?? Promise.resolve({ success: false, error: 'Not available' }),
  deployAssistantCancel: (o) => window.electron?.deployAssistantCancel?.(o) ?? Promise.resolve({ success: false, error: 'Not available' }),
  onDeployAssistantProgress: (cb) => window.electron?.onDeployAssistantProgress?.(cb),
