...
const { registerSshKeysHandlers } = require('./handlers/ssh-keys')
...
const { registerDeployAssistantHandlers } = require('./handlers/deploy-assistant')
